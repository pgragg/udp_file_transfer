...
var WriterMessageReceiver = /** @class */ (function () {
    ...
    WriterMessageReceiver.prototype.enactMessage = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var document, fileDescriptor, buffer;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!('data' in message.payload)) {
                            return [2 /*return*/, result_1.Result.Failure(new Error('Expected data field.'))];
                        }
                        document = message.payload;
                        fileDescriptor = fs_1.default.openSync(this.targetFileName, 'a');
